...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (cmd === 'monitorkey' && !game.started) {
    game.play('standard');
  }
  else if (cmd === 'monitorkey' && timeNow > BUFFER + currTime && game.started) {
    // left side
